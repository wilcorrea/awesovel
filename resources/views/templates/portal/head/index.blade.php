...
<!-- Bootstrap Plugins -->
{{--<link href="{{ awesovel_asset('bootstrap/plugins/bootstrap-dialog/css/bootstrap-dialog.min.css') }}" rel="stylesheet">--}}
...
<!-- Bootstrap Plugins -->
<script src="{{ awesovel_asset('bootstrap/plugins/bootstrap-dialog/js/bootstrap-dialog.min.js') }}"></script>
